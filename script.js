...
let timerTotalMs = 0;      // total countdown in milliseconds
let timerIntervalId = null;
let timeRemaining = 0;     // dynamic countdown
let timerIsRunning = false;

// Format the display of the countdown
...
timerStartBtn.addEventListener("click", () => {
  if (!timerIsRunning) {
    ...
    if (!timerIntervalId) {
      ...
      timerTotalMs = minutesToCount * 60 * 1000;  // convert minutes to ms
